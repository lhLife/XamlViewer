namespace XamlViewer.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.lhLife.XamlViewer";
    public readonly static string AndroidAppName = "com.lhLife.XamlViewer";
